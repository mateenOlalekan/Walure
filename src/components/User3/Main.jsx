import {  LogOut, Bell, MessageSquare, Download, Filter,CheckCircle, XCircle, Clock4,Search,Route } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-8 gap-4 lg:gap-6 p-4 lg:p-6 min-h-screen">
        ...
        <div className="col-span-1 lg:col-span-5 overflow-y-scroll">
        ...
        <div className="col-span-1 lg:col-span-3 overflow-y-auto">
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-xl shadow-sm p-2">
              <div className="flex items-center w-full bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
                <Search className="text-gray-500 w-5 h-5 flex-shrink-0" />
                <input
                  type="text"
                  placeholder="Search for destinations, hotels, or routes..."
                  className="flex-1 px-3 py-1 text-sm text-gray-700 focus:outline-none bg-transparent"
                />
                <button className="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200">
