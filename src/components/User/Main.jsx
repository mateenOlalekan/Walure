    ...
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full flex flex-col lg:flex-row mt-5">
          ...
          <div className="w-full lg:w-80 flex-shrink-0 overflow-y-auto px-2 sm:px-6 pb-6 lg:pr-6">
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 sticky top-0">
              {/* Profile Section */}
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition">
          ...
          <div>
            <p className="text-gray-800 font-medium text-sm sm:text-base">New Notification</p>
        ...
        <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition">
          ...
          <div>
            <p className="text-gray-800 font-medium text-sm sm:text-base">System Update</p>
            <p className="text-gray-500 text-xs sm:text-sm">June 16, 2022 - Thursday</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition">
        ...
        <div>
          <p className="text-gray-800 font-medium text-sm sm:text-base">Upcoming Meeting</p>
          <p className="text-gray-500 text-xs sm:text-sm">June 16, 2022 - Thursday</p>
        </div>
      </div>
      ...
      {/* Private Section */}
      <div>
        <h2 className="text-base sm:text-lg font-semibold text-gray-800">Private</h2>
